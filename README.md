			...
			function ElementFunction:AddPlayersDropdown(DropdownConfig)
				...
				local function RemoveOption(Option)
					if Dropdown.Buttons[Option] then
						...
						local stateIcon = Dropdown.Buttons[Option]:FindFirstChild("State")

						if n and stateIcon then
					...
					if Button then
						if Dropdown.MultipleSelection then
							...
							elseif n and not Once then
								...
								local stateIcon = Dropdown.Buttons[Value]:FindFirstChild("State")
								if stateIcon and stateIcon.Visible then
